...
namespace VertusNaurellesEcommerceV1.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Mot de passe actuel est requis")]
            [DataType(DataType.Password)]
            [Display(Name = "Mot de passe actuel")]
            public string OldPassword { get; set; }

            [Required(ErrorMessage = "Nouveau mot de passe est requis")]
            [StringLength(100, ErrorMessage = "{0} doit comporter au moins {2} et au maximum {1} caractères.", MinimumLength = 6)]
            [DataType(DataType.Password)]
            ...
            [Compare("NewPassword", ErrorMessage = "Nouveau mot de passe et le mot de passe de confirmation ne correspondent pas.")]
